...
class StandardEnemy :public Characters{
public:
	StandardEnemy();
	...
	//operator equal 
	StandardEnemy& operator=(const StandardEnemy& other) {
		if (this == &other) {
			return *this;
		}
		return *this;
...
private:
	...
	bool m_died = false;
	int m_hp = 3,m_lives = 1,m_damage = 1;
	...
	float movementSpeed = 100 + rand()%150;
	sf::Vector2f velocity = sf::Vector2f(0, 0);
	float m_dx = 0, m_dy = 0,
		jumpStartedFrom = 0;
	float staeneGravity = 9.8f;
	sf::Clock m_timer;
